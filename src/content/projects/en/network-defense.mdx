...
proofs:
  - { src: "/portfolio/fonts/projects/net.png", alt: "Network Monitoring — Grafana dashboard sample 1" }
  - { src: "/portfolio/fonts/projects/net1.png", alt: "Network Monitoring — Grafana dashboard sample 2" }
---
